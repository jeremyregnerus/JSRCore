// <copyright file="MessengerCollection.cs" company="Jeremy Regnerus">
...
namespace JSR.BaseClassLibrary
{
    ...
    public class MessengerCollection<T> : ObservableCollection<T>, IMessengerCollection<T> where T : IMessenger
    {
        private string message;

        /// <summary>
        /// Initializes a new instance of the <see cref="MessengerCollection{T}"/> class.
        /// </summary>
        public MessengerCollection() : base()
        {
            OnCreated();
        }
        ...
        public MessengerCollection(IEnumerable<T> collection) : base(collection)
        {
            OnCreated();
        }
        ...
        public MessengerCollection(List<T> list) : base(list)
        {
            OnCreated();
        }
